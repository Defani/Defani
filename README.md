...
- 🛠️ Builds and maintains **fully open-source geospatial workflows** — QGIS, R, Python, and Google Earth Engine — instead of proprietary GIS software, including **[RasterViz](https://plugins.qgis.org/plugins/qrviz/)**, a QGIS plugin with **900+ users worldwide** 🌐.
